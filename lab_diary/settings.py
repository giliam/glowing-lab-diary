"""
Django settings for lab_diary project.
...
from lab_diary.generate_secret_key import secret_key_from_file
from lab_diary import parameters
...
WSGI_APPLICATION = "lab_diary.wsgi.application"
...
STATIC_ROOT = (
    ...
    else "/var/www/example.com/static/"
)
